...
import com.obriand.inapptut.C.PurchaseState;
import com.obriand.inapptut.util.Base64;
import com.obriand.inapptut.util.Base64DecoderException;
...
public class BillingSecurity {
	...
	public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
		...
		if (!TextUtils.isEmpty(signature)) {
			 ...
			 */
			String base64EncodedPublicKey = ""; //PUT YOUR PUBLIC KEY HERE
