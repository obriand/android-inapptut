...
import com.obriand.inapptut.C.ResponseCode;
...
public class BillingHelper {
	...
	protected static boolean isBillingSupported() { // for subs (other is inapp)
		if (amIDead()) {
			return false;
		}
		Bundle request = makeRequestBundle("CHECK_BILLING_SUPPORTED");
		request.putString("ITEM_TYPE", "subs"); // for subs (other is inapp)
		if (mService != null) {
			try {
	...
	private static void startBuyPageActivity(PendingIntent pendingIntent, Intent intent, Context context){
		...
		try {
			...
			Log.i(TAG, "start purchase intent : it launchs buy page of Google Play ie checkout UI");
